...
namespace IdleGame.GameCore
{
    ...
    public static class Loc
    {
        ...
        internal static readonly Dictionary<string, string> En = new()
        {
            ...
            ["gacha.title"] = "Summon",
            ["gacha.wallet"] = "Gems: <color=#a6d8ff>{0}</color>",
            ["gacha.no-banners"] = "No banners are live right now — check back soon.",
            ["gacha.featured"] = "Featured: <color=#ffd766>{0}</color>",
            ["gacha.cost"] = "Cost: <color=#a6d8ff>{0} gems</color> per roll",
            ["gacha.pity-progress"] = "{0} / {1} rolls to guarantee {2}",
            ["gacha.roll"] = "Roll",
            ...
            // ---- equip slots (the enum name used to be interpolated straight into the UI) ----
            ["slot.weapon"] = "Weapon",
            ["slot.helm"] = "Helm",
            ["slot.chest"] = "Chest",
            ["slot.gloves"] = "Gloves",
            ...
            ["inv.sort"] = "Sort",
            ["inv.select"] = "Select",
            ["inv.select-hint"] = "Tap items to select — drag to sweep.",
            ["inv.salvage-selected"] = "Salvage {0} selected  (+{1} scrap)",
            ["inv.hint"] = "Hover or click an item.",
            ["inv.slot-line"] = "{0} · item level {1}",
            ["inv.enhanced"] = "Enhanced +{0} · +{1:0}% base stats",
            ["inv.imprinted-affix"] = "✦ Imprinted — {0}",
            ["inv.affix"] = "+{0} {1}",
            ["inv.enhance"] = "Enhance → +{0}  {1}s{2}",
            ["inv.enhance-odds"] = "  {0:0}%",
            ["inv.enhance-odds-risky"] = "  {0:0}% ⚠",
            ["inv.reforge"] = "Reforge  {0}g + {1}s",
            ["inv.equipped-by"] = "Equipped by {0}",
            ["inv.lock"] = "Lock",
            ["inv.lock-badge"] = "[L]",
            ["inv.locked-cant-salvage"] = "Locked — unlock to salvage",
            ["inv.imprint-guarded"] = "✦ Imprinted — guarded by the loot filter",
            ["inv.salvage"] = "Salvage  +{0} scrap",
            ["inv.confirm-salvage"] = "Confirm salvage  +{0}",
            ["inv.salvage-all"] = "Salvage all",
            ["inv.confirm-salvage-all"] = "Confirm salvage all ({0})",
            ["inv.auto-equip"] = "Auto-equip: {0}",
            ["inv.loot-filter"] = "Loot filter: {0}  {1}",
            ["inv.all-slots"] = "All slots",
            ["inv.keep-imprinted"] = "Keep imprinted",
            ["inv.filter-custom"] = "Custom",
            // "& below" mirrors Inventory.WouldAutoSalvage's `Rarity <= floor` semantics.
            ["inv.filter-normal"] = "Normal",
            ["inv.filter-rare"] = "Rare & below",
            ["inv.filter-unique"] = "Unique & below",
