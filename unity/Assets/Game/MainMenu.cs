...
namespace IdleGame.Game
{
    ...
    public sealed class MainMenu : MonoBehaviour
    {
        ...
        public void Open()
        {
            ...
            var panel = UiKit.Panel(canvas.transform, new Vector2(440, 380), new Color(0.10f, 0.10f, 0.14f, 1f));
            UiKit.Label(panel.transform, "IDLE ARPG", 36, TextAnchor.MiddleCenter, new Vector2(400, 60), new Vector2(0, 130));

            var cont = UiKit.TextButton(panel.transform, "Continue", new Vector2(300, 54), new Vector2(0, 36),
                () => { CloseAnd(OnContinue); });
            cont.interactable = HasSave;

            UiKit.TextButton(panel.transform, "New Game", new Vector2(300, 54), new Vector2(0, -36), NewGameClicked);

            UiKit.Label(panel.transform, HasSave ? "" : "No save yet — start a new game",
                        14, TextAnchor.MiddleCenter, new Vector2(400, 24), new Vector2(0, -150));
        }
